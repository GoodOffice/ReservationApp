...
/*Gets*/
inline int Location::getLocation_Id() {
    return location_id;
};

string Location::getLocation_Name() {
    return location_name;
};

int Location::getLocation_Status() {
...
/*Sets*/
void Location::setLocation_Id(int loc_id) {
    this->location_id = loc_id;
}

void Location::setLocation_Name(string loc_name) {
    this->location_name = loc_name;
}

void Location::setLocation_Status(int loc_status) {
    this->location_status = loc_status;
}
